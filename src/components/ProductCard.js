...
// Komponen Card harus menerima props 'p' (data produk)
export default function ProductCard({ p }) {
  // JANGAN gunakan useParams di sini karena ini komponen list, bukan halaman detail
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden relative group hover:shadow-xl transition-all duration-300 flex flex-col h-full">
      ...
      {/* ACTION BUTTON - Mengarah ke /product/ sesuai folder kamu */}
